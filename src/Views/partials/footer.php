<footer class="site-footer">
  <div class="container ftr">
    ...
    <div class="ftr-contact">
      <?php if (settings_get('show_footer_phone','1') === '1' && settings_get('support_phone','') !== ''): ?>
      ...
      <?php endif; ?>
      <?php if (settings_get('show_footer_whatsapp','1') === '1' && settings_get('whatsapp','') !== ''): ?>
      ...
      <?php endif; ?>
      <?php if (settings_get('show_footer_facebook','1') === '1' && settings_get('facebook_handle','') !== ''): ?>
